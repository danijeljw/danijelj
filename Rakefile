...
ssh_user       = "danijelj.com"
ssh_port       = "22"
document_root  = "/home/danijeljames/html"
rsync_delete   = true
...
task :new_post, :title do |t, args|
  ...
  open(filename, 'w') do |post|
    ...
    post.puts "author: Danijel James"
...
task :pingomatic do
  begin
    ...
    XMLRPC::Client.new('rpc.pingomatic.com', '/').call('weblogUpdates.extendedPing', 'danijelj.com' , 'http://danijelj.com', 'http://danijelj.com/atom.xml')
  rescue LoadError
...
task :sitemapgoogle do
  begin
    ...
    Net::HTTP.get('www.google.com', '/webmasters/tools/ping?sitemap=' + URI.escape('http://danijelj.com/sitemap.xml'))
  rescue LoadError
...
task :sitemapbing do
  begin
    ...
    Net::HTTP.get('www.bing.com', '/webmaster/ping.aspx?siteMap=' + URI.escape('http://danijelj.com/sitemap.xml'))
  rescue LoadError
...
task :pingpubsubhubbub do
  begin
    ...
    data = 'hub.mode=publish&hub.url=' + CGI::escape("http://danijelj.com/atom.xml")
